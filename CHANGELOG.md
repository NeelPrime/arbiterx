...
- 10 engineering rules enforced via static analysis (YAGNI, error handling, type safety, resource cleanup, no magic numbers, no dead code, single responsibility, fail fast, idempotency, performance)
