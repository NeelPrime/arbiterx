...
<p align="center">
  ...
  <a href="https://pypi.org/project/arbiterx/"><img src="https://img.shields.io/badge/pypi-arbiterx-orange?style=flat-square" alt="PyPI"></a>
...
<p align="center">
  ...
  <br>
  <sub>↑ <code>pip install arbiterx && arbiterx init && arbiterx map</code></sub>
</p>
...
- **Zero config** — `pip install arbiterx && arbiterx init` and you're done
- **Runs locally** — Your code never leaves your machine
- **Actually tested** — 109 tests, benchmarked on real code, not vaporware

```bash
pip install arbiterx && arbiterx init && arbiterx map
```
